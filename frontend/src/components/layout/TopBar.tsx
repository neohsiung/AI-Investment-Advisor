...
import { LogOut, User as UserIcon, Bell, Settings, Search, Loader2, Zap, ZapOff } from "lucide-react";
...
export default function TopBar() {
  ...
  return (
    <header className="flex justify-between items-center px-8 h-16 fixed top-0 left-64 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-outline-variant/10">
      ...
      <div className="flex items-center gap-4">
        <div className="relative group">
          <input 
            ...
            className="bg-surface-container-low border-none text-on-surface text-xs font-label uppercase tracking-wider rounded-md pl-10 pr-4 py-2 w-64 focus:ring-1 focus:ring-primary-container transition-all"
          />
