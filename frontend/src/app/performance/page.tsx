  ...
  return (
    <div className="flex-1 overflow-y-auto pt-16 sm:pt-20 lg:pt-24 px-4 sm:px-6 lg:px-8 pb-8 bg-background">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-6 lg:mb-8">
        <div>
          <h1 className="text-2xl lg:text-4xl font-bold font-headline tracking-tighter mb-2">績效追蹤 <span className="text-primary/50 text-xl lg:text-2xl">Performance</span></h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8 mb-6 lg:mb-8">
        {/* Main Growth Chart */}
        <div className="lg:col-span-2 bg-surface-container-low p-4 lg:p-8 rounded-3xl border border-outline-variant/10 shadow-sm">
        ...
        {/* Agent Leaderboard */}
        <div className="bg-surface-container-low p-4 lg:p-8 rounded-3xl border border-outline-variant/10 shadow-sm flex flex-col">
          <h3 className="font-headline font-bold text-lg tracking-tight mb-4 lg:mb-8">Agent 歸因準確度</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
        <div className="bg-surface-container-low p-4 lg:p-8 rounded-3xl border border-outline-variant/10 shadow-sm">
          <h3 className="font-headline font-bold text-lg tracking-tight mb-4 lg:mb-8">槓桿趨勢 <span className="text-[10px] font-label uppercase tracking-widest text-on-surface-variant ml-4">Exposure Ratio</span></h3>
        ...
        <div className="bg-surface-container-low p-4 lg:p-8 rounded-3xl border border-outline-variant/10 shadow-sm">
          <h3 className="font-headline font-bold text-lg tracking-tight mb-4 lg:mb-8">累積報酬統計</h3>
