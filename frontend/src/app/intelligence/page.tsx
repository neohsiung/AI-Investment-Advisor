...
export default function IntelligenceBriefing() {
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-16 sm:pt-20 lg:pt-24 px-4 sm:px-6 lg:px-8 pb-8 animate-in slide-in-from-bottom duration-700">
      <div className="max-w-6xl mx-auto space-y-8 lg:space-y-12 py-6 lg:py-12">
      {/* Header */}
