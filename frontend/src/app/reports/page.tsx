...
export default function ReportsPage() {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row overflow-hidden bg-background pt-16">
      {/* Sidebar - Report List */}
      <div className="w-full md:w-80 lg:w-96 border-b md:border-b-0 md:border-r border-outline-variant/10 flex flex-col bg-surface-container-low md:flex-shrink-0 max-h-64 md:max-h-none">
