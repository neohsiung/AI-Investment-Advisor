...
class TestAuthGuard:
    ...
    def test_require_authentication_loading(self, mock_st, mock_auth):
    ...
    @patch('src.utils.auth_guard.auth_manager')
    @patch('src.utils.auth_guard.st')
    def test_require_authentication_unauthenticated(self, mock_st, mock_auth):
    ...
    @patch('src.utils.auth_guard.auth_manager')
    @patch('src.utils.auth_guard.st')
    def test_require_authentication_false(self, mock_st, mock_auth):
    ...
    @patch('src.utils.auth_guard.auth_manager')
    @patch('src.utils.auth_guard.st')
    def test_require_authentication_authenticated_success(self, mock_st, mock_auth):
    ...
    @patch('src.utils.auth_guard.auth_manager')
    @patch('src.utils.auth_guard.st')
    def test_require_authentication_invalid_user_data(self, mock_st, mock_auth):
