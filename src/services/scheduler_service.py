...
class SchedulerService:
    ...
    def job_daily_check(self):
        ...
        for user in users:
            try:
                ...
                subprocess.run([sys.executable, "src/workflow.py", "--mode", "daily", "--user_id", user], check=True)
    ...
    def job_weekly_report(self):
        ...
        for user in users:
            try:
                subprocess.run([sys.executable, "src/workflow.py", "--mode", "weekly", "--user_id", user], check=True)
