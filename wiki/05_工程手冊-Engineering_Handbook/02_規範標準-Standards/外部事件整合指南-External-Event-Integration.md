...
### 1. Interface Specs
- **Method**: `POST`
- **Endpoint**: `/webhook/{source}`
- **Auth**: Mandatory `X-Webhook-Secret` header.
...
- **Architecture**: [Sentinel & Council Architecture](../../04_架構觀點-Architect_Views/哨兵與評議會架構-Sentinel-Council-Architecture)
