...
- **核心功能**: 
    ...
    - **任務規劃引擎**: [Task Planning Engine](任務規劃與執行引擎-Task-Planning-Engine) 實作多模型動態路由。
...
- **核心功能**: 實現 System 1 (快思) 與 System 2 (慢想) 的認知架構。
    - **主動監控 (Sentinel)**: [哨兵架構](哨兵與評議會架構-Sentinel-Council-Architecture) 實現 7x24 市場事件監聽。
...
- **Automation Specs**: [Future Roadmap Specs](未來演進規格-Future-Roadmap-Specs)
